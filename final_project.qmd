...
Our data show that service producing industries, which reached their highest employment in December 2019, fell by about 20% at their lowest point. Goods producing industries fell by about 17.56% at their lowest point. These findings match RBC (2022), which says that high-contact, service-based sectors were hit harder by pandemic rules and recovered more slowly than other sectors.

When we look at average employment before and after the pandemic, we see that some goods producing industries, like Construction, rebounded by about 9.31%. Manufacturing and Mining returned to near their pre-pandemic levels. These trends match StatCan (2022), which says that industries tied to supply chains and infrastructure got back on track faster.

But Accommodation and Food Services had a 10.27% drop in average employment after the pandemic. This shows the problems that high-contact service sectors faced. These results also match RBC (2022), which says that changes in consumer behavior, health rules, and travel patterns slowed their recovery. But Healthcare and Transportation grew by about 12.6% and 6.96%. This suggests that industries linked to essential services and logistics found ways to meet new demands. Environics Analytics (2021) also found that changing population and health needs shaped labor market trends.
...
Clarke, Sean, and Andrew Fields. “Employment Growth in Canada and the United States during the Recovery from COVID-19.” Statistics Canada, 22 Dec. 2022, www150.statcan.gc.ca/n1/pub/36-28-0001/2022012/article/00001-eng.htm. 

Norris, Doug. “The Impact of Covid-19 on Population, Employment, Social and Economic Trends in Canada.” Environics Analytics, 25 Mar. 2021, environicsanalytics.com/en-ca/resources/blogs/ea-blog/2021/03/25/the-impact-of-covid-19-on-population-employment-social-and-economic-trends-in-canada. 

Powell, Naomi, et al. “Canada’s Post-Pandemic Labour Market Shakeup.” RBC Thought Leadership, 13 Sept. 2022, thoughtleadership.rbc.com/canadas-post-pandemic-labour-market-shakeup/. 
